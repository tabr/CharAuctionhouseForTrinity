...
function f_tcalParseDate (s_date) {
	...
	if (!re_date.exec(s_date))
		return alert ("неверная дата: '" + s_date + "'.\nдопустимы формат гггг-мм-дд.")
	...
	if (n_month < 1 || n_month > 12)
		return alert ("недопустимое значение месяца: '" + n_month + "'.\nдопустимый диапазон: 01-12.");
	var d_numdays = new Date(n_year, n_month, 0);
	if (n_day > d_numdays.getDate())
		return alert("неверное значения дня: '" + n_day + "'.\nдопустимы диапазон для выьранного месяца: 01 - " + d_numdays.getDate() + ".");
